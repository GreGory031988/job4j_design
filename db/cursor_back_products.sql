...
BEGIN;
DECLARE
cursor_back_products cursor for
select * from products;

FETCH LAST FROM cursor_back_products;

MOVE BACKWARD 4 FROM cursor_back_products;
FETCH PRIOR FROM cursor_back_products;

MOVE FORWARD 1 FROM cursor_back_products;
FETCH BACKWARD 9 cursor_back_products;

MOVE FORWARD 1 FROM cursor_back_products;
FETCH BACKWARD 6 cursor_back_products;

FETCH PRIOR cursor_back_products;

Close cursor_back_products;
